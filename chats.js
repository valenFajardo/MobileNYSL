 ...
 */
// [START write_fan_out]
// identifica las caracteristicas de cada post
function writeNewPost(uid, username, picture, title, body) {
  ...
  updates['/game-posts/' + 'match' + '/' + $("#chats-NYSL").attr("class") + '/' + newPostKey ] = postData;
...
function startDatabaseQueries() {
  ...
  var recentPostsRef = firebase.database().ref('game-posts/match/'+ $("#chats-NYSL").attr("class")).limitToLast(100);
...
function matchId(evt){
    $("#chats-NYSL").show();
    $("#home-NYSL").hide();
    $("#info-NYSL").hide();
    $("#location-NYSL").hide();
    $("nav").removeClass("navbar-home").removeClass("bg-nav");
    $("nav").addClass("bg-light")
    $("h1").hide();
    var id = evt.target.id
    $("#chats-NYSL").attr("class", "")
    $("#chats-NYSL").addClass(id)
    onAuthStateChanged()
    startForum()
}
